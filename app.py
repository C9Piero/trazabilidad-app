...
def generar_pdf_oficial(
    ...
    data_balance = [
        ...
        [Paragraph("Retazos aprovechables", cell_style), Paragraph¡No te preocupes, es totalmente normal! 

Soy **Gemini**, un asistente de inteligencia artificial, y estoy aquí para ayudarte en lo que necesites de forma sencilla.

### ¿En qué te puedo echar una mano?

* **Explicar temas difíciles:** Si hay algo que leíste o estudiaste y no te queda claro, me lo pides y te lo desgloso paso a paso.
* **Redactar y corregir:** Puedo ayudarte a escribir correos, resúmenes, ensayos o mejorar cualquier texto.
* **Resolver dudas:** Desde preguntas sobre ciencia, historia o matemáticas, hasta tecnología o consejos prácticos.
* **Dar ideas o planificar:** Organizar viajes, crear rutinas de estudio o darte ideas para un proyecto.

---

¿Hay algo en particular sobre lo que tenías dudas o algún tema con el que quieras que empecemos?
